    ...
    <footer className="mb-5 sm:mb-10 px-16 py-4 mt-8 flex flex-col gap-4 justify-between items-center bg-blue-950 text-white">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-6 lg:gap-32">
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          <img src="https://i.imgur.com/JQXUMYM.png" className=" h-[5rem] lg:h-[8rem]" />
        ...
        <div className="flex flex-col items-center lg:items-start gap-1">
          ...
          <div className="flex justify-center mt-6 items-center gap-4 sm:gap-6 text-2xl sm:mt-2">
      ...
      <small className="mb-2 text-center lg:text-left text-sm">&copy; 2024 Grow Educators. All rights reserved.</small>
    </footer>
  )
}
