    ...
    <section className="w-full h-screen">
      <div className="flex flex-col sm:flex-row-reverse items-center justify-center px-6 py-12 lg:px-48 lg:pt-28 lg:pb-20">
        ...
        <div className="flex flex-col lg:w-1/2">
          <h2 className="text-blue-950 text-3xl lg:text-4xl font-semibold leading-relaxed">School</h2>
      ...
      <div className='flex flex-col justify-center'>
        <h2 className="text-lg w-[70%] mx-auto lg:text-3xl font-semibold text-center lg:pl-40 text-red-600">{`What's special about our SCHOOL Programs?`}</h2>
